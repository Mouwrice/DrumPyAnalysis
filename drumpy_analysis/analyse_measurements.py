...
measurements = [
    ...
    # ),
    # Measurement(
    #     base_recording="data/qualisys/Data/maurice_drum_60fps_01.tsv",
    #     diff_recording="data/measurements/maurice_drum_60fps_01/LITE/trajectories.csv",
    #     output_prefxix="data/measurements/maurice_drum_60fps_01/LITE/",
    #     markers=all_markers,
    #     diff_frame_offset=27
    # ),
    # Measurement(
    #     base_recording="data/qualisys/Data/maurice_drum_60fps_01.tsv",
    #     diff_recording="data/measurements/maurice_drum_60fps_01/FULL/trajectories.csv",
    #     output_prefxix="data/measurements/maurice_drum_60fps_01/FULL/",
    #     markers=all_markers,
    #     diff_frame_offset=27
    # ),
    # Measurement(
    #     base_recording="data/qualisys/Data/maurice_drum_60fps_01.tsv",
    #     diff_recording="data/measurements/maurice_drum_60fps_01/HEAVY/trajectories.csv",
    #     output_prefxix="data/measurements/maurice_drum_60fps_01/HEAVY/",
    #     markers=all_markers,
    #     diff_frame_offset=27
    # ),
    # Measurement(
    #     base_recording="data/qualisys/Data/maurice_drum_60fps_02.tsv",
    #     diff_recording="data/measurements/maurice_drum_60fps_02/LITE/trajectories.csv",
    #     output_prefxix="data/measurements/maurice_drum_60fps_02/LITE/",
    #     markers=all_markers,
