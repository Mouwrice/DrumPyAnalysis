...
class QTM:
    ...
    class Frame:
        ...
        def from_tsv_row(
            ...
            return QTM.Frame(time_ms, frame, marker_positions)
    ...
    def from_tsv(path: str) -> "QTM":
        ...
        with open(path, "r") as file:
            ...
            for i, row in enumerate(reader):
                ...
                frames.append(
                    QTM.Frame.from_tsv_row(row, marker_names, i * time_delta, i)
                )
